  ...
  document.getElementById("navbarToggleExternalContent").style.width = "0%";
	...
	<br>
		...
		<fieldset class="fsetComp">
			<legend>Ma petite histoire</legend>
			J'ai obtenu mon baccalauréat Scientifique en Juillet 2015 au lycée LALA FATMA NSOUMER à Amizour,Algerie.<br>
			J'ai fait une année d'études en Sciences et Technologies de sep 2015 à Juin 2016, à l'Université ABDERAHMANE MIRA de BEJAIA. Au cours de cette année, j'ai passé un autre BAC Science.
		</fieldset>
